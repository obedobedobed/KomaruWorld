...
public static class TilesBank
{
    ...
    // Tiles
    public static Tile Grass(Vector2 position) => new Tile(GrassTexture, position, TileSize, true, Tiles.Grass, toolToDestroy: ToolToDestroy.Pickaxe, destroyTime: 0.7f, new DropData([ItemsBank.Dirt], [100], [new Range(1, 1)]));
    public static Tile Dirt(Vector2 position) => new Tile(DirtTexture, position, TileSize, true, Tiles.Dirt, toolToDestroy: ToolToDestroy.Pickaxe, destroyTime: 0.7f, new DropData([ItemsBank.Dirt], [100], [new Range(1, 1)]));
    public static Tile Stone(Vector2 position) => new Tile(StoneTexture, position, TileSize, true, Tiles.Stone, toolToDestroy: ToolToDestroy.Pickaxe, destroyTime: 0.9f, new DropData([ItemsBank.Stone], [100], [new Range(1, 1)]));
